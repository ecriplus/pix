...
module('Unit | Component | routes/organizations/sco-form', function (hooks) {
  setupTest(hooks);
  setupIntl(hooks);
  ...
  hooks.beforeEach(function () {
    ...
    component = createComponent('routes/organizations/sco-form', {
  ...
  module('#validateForm', function (hooks) {
    ...
    module('while waiting for submission completion', function () {
      test('isLoading is true', async function (assert) {
        ...
        const component = createComponent('routes/organizations/sco-form', {
          onSubmit: function () {
