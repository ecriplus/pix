...
module('Unit | Component | routes/organizations/invited/associate-sup-student-form', function (hooks) {
  setupTest(hooks);
  setupIntl(hooks);
  ...
  hooks.beforeEach(function () {
    ...
    component = createComponent('routes/organizations/invited/associate-sup-student-form', {
      campaignCode: 123,
    });
