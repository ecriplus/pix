...
module('Unit | Component | routes/organizations/join/associate-sco-student-with-mediacentre-form', function (hooks) {
  setupTest(hooks);
  setupIntl(hooks);
  ...
  hooks.beforeEach(function () {
    ...
    component = createComponent('routes/organizations/join/associate-sco-student-with-mediacentre-form', {
