export default function (schema, request) {
  ...
  const campaignParticipationResult = schema.campaignParticipationResults.find(campaignParticipationId);
  campaignParticipationResult.update({ isShared: true, sharedAt: new Date('2020-02-27') });
