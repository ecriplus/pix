...
import AssociateSupStudentForm from 'mon-pix/components/routes/campaigns/invited/associate-sup-student-form';
<template>
  ...
  <div class="background-banner-wrapper">
    ...
    >
      <div class="join-restricted-campaign">
        <AssociateSupStudentForm @organizationName={{@model.organizationName}} @campaignCode={{@model.code}} />
      </div>
    </main>
  </div>
</template>
