...
import Information from 'pix-admin/components/complementary-certifications/item/target-profile/information';
import { module, test } from 'qunit';

module('Integration | Component | complementary-certifications/item/target-profile/information', function (hooks) {
