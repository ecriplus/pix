...
module('Unit | Component | complementary-certifications/item/target-profile/information', function (hooks) {
  setupTest(hooks);
    ...
    module('when there is multiple current target profiles', function () {
      test('it should return true', async function (assert) {
        ...
        const component = createGlimmerComponent(
          'component:complementary-certifications/item/target-profile/information',
        );
