...
const testRef = 'DROIT_32OK-0KO_RejectForFraud';
const snapshotPath = `recette-certif/${testRef}/${testRef}.json`;

test(
  `${testRef} - User takes a certification test for a Pix+ Droit subscription. 32 right answers then rejected for fraud`,
  {
    tag: ['@snapshot'],
    annotation: [
      {
