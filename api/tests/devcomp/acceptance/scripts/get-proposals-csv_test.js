  ...
  describe('#getProposalsListAsCsv', function () {
    it(`should return proposals list as CSV`, async function () {
      ...
      expect(proposalsListAsCsv).to
        .equal(`\ufeff"ProposalModuleSlug"\t"ProposalGrainTitle"\t"ProposalGrainId"\t"ProposalGrainPosition"\t"ProposalElementId"\t"ProposalElementType"\t"ProposalActivityElementPosition"\t"ProposalElementInstruction"\t"ProposalId"\t"ProposalContent"\t"ProposalIsSolution"
"bac-a-sable"\t"Voici un vrai-faux"\t"533c69b8-a836-41be-8ffc-8d4636e31224"\t4\t"71de6394-ff88-4de3-8834-a40057a50ff4"\t"qcu"\t1\t"<p>Pix évalue 16 compétences numériques différentes.</p>"\t"'1"\t"'Vrai"\t"=TRUE"
"bac-a-sable"\t"Voici un vrai-faux"\t"533c69b8-a836-41be-8ffc-8d4636e31224"\t4\t"71de6394-ff88-4de3-8834-a40057a50ff4"\t"qcu"\t1\t"<p>Pix évalue 16 compétences numériques différentes.</p>"\t"'2"\t"'Faux"\t"=FALSE"
"bac-a-sable"\t"Les 3 piliers de Pix"\t"0be0f5eb-4cb6-47c2-b9d3-cb2ceb4cd21c"\t5\t"30701e93-1b4d-4da4-b018-fa756c07d53f"\t"qcm"\t2\t"<p>Quels sont les 3 piliers de Pix&#8239;?</p>"\t"'1"\t"'Evaluer ses connaissances et savoir-faire sur 16 compétences du numérique"\t"=TRUE"
"bac-a-sable"\t"Les 3 piliers de Pix"\t"0be0f5eb-4cb6-47c2-b9d3-cb2ceb4cd21c"\t5\t"30701e93-1b4d-4da4-b018-fa756c07d53f"\t"qcm"\t2\t"<p>Quels sont les 3 piliers de Pix&#8239;?</p>"\t"'2"\t"'Développer son savoir-faire sur les jeux de type TPS"\t"=FALSE"
"bac-a-sable"\t"Les 3 piliers de Pix"\t"0be0f5eb-4cb6-47c2-b9d3-cb2ceb4cd21c"\t5\t"30701e93-1b4d-4da4-b018-fa756c07d53f"\t"qcm"\t2\t"<p>Quels sont les 3 piliers de Pix&#8239;?</p>"\t"'3"\t"'Développer ses compétences numériques"\t"=TRUE"
"bac-a-sable"\t"Les 3 piliers de Pix"\t"0be0f5eb-4cb6-47c2-b9d3-cb2ceb4cd21c"\t5\t"30701e93-1b4d-4da4-b018-fa756c07d53f"\t"qcm"\t2\t"<p>Quels sont les 3 piliers de Pix&#8239;?</p>"\t"'4"\t"'Certifier ses compétences Pix"\t"=TRUE"
"bac-a-sable"\t"Les 3 piliers de Pix"\t"0be0f5eb-4cb6-47c2-b9d3-cb2ceb4cd21c"\t5\t"30701e93-1b4d-4da4-b018-fa756c07d53f"\t"qcm"\t2\t"<p>Quels sont les 3 piliers de Pix&#8239;?</p>"\t"'5"\t"'Evaluer ses compétences de logique et compréhension mathématique"\t"=FALSE"
"bac-a-sable"\t"Activité remonter dans la page"\t"2a77a10f-19a3-4544-80f9-8012dad6506a"\t6\t"0a5e77e8-1c8e-4cb6-a41d-cf6ad7935447"\t"qcu"\t3\t"<p>Remontez la page pour trouver le premier mot de ce module.<br>Quel est ce mot&#8239;?</p>"\t"'1"\t"'Bienvenue"\t"=FALSE"
"bac-a-sable"\t"Activité remonter dans la page"\t"2a77a10f-19a3-4544-80f9-8012dad6506a"\t6\t"0a5e77e8-1c8e-4cb6-a41d-cf6ad7935447"\t"qcu"\t3\t"<p>Remontez la page pour trouver le premier mot de ce module.<br>Quel est ce mot&#8239;?</p>"\t"'2"\t"'Bonjour"\t"=TRUE"
"bac-a-sable"\t"Activité remonter dans la page"\t"2a77a10f-19a3-4544-80f9-8012dad6506a"\t6\t"0a5e77e8-1c8e-4cb6-a41d-cf6ad7935447"\t"qcu"\t3\t"<p>Remontez la page pour trouver le premier mot de ce module.<br>Quel est ce mot&#8239;?</p>"\t"'3"\t"'Nous"\t"=FALSE"`);
    });
  });
});
