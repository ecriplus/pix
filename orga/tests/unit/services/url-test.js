...
module('Unit | Service | url', function (hooks) {
  ...
  module('#supportHelpCenterUrl', function () {
    [
      ...
      { locale: 'fr-FR', extension: 'fr', type: 'SCO-2D', expectedUrl: 'https://pix.fr/support/enseignement-scolaire' },
      ...
      { locale: 'fr', extension: 'org', type: 'SCO-2D', expectedUrl: 'https://contact.pix.org/fr/hc/1137130200' },
      ...
      { locale: 'fr-BE', extension: 'org', type: 'SCO-2D', expectedUrl: 'https://contact.pix.org/fr/hc/1137130200' },
      ...
      { locale: 'nl-BE', extension: 'org', type: 'SCO-2D', expectedUrl: 'https://pix.org/nl-be/support' },
      ...
      { locale: 'en', extension: 'org', type: 'SCO-2D', expectedUrl: 'https://pix.org/en/support' },
      ...
      { locale: 'de-AT', extension: 'org', type: 'SCO-2D', expectedUrl: 'https://pix.org/en/support' },
      ...
      { locale: 'it', extension: 'org', type: 'SCO-2D', expectedUrl: 'https://pix.org/en/support' },
      ...
      { locale: 'es', extension: 'org', type: 'SCO-2D', expectedUrl: 'https://pix.org/en/support' },
      ...
      { locale: 'es-419', extension: 'org', type: 'SCO-2D', expectedUrl: 'https://pix.org/en/support' },
